...
const q = (
  id: string,
  text: string,
  options: [string, Partial<Record<Dimension, number>>][],
): Question => ({
  id,
  text,
...
export const STACY_QUESTIONS: Question[] = [
  ...
  scale(
    ...
    "The room adjusts to me",
    "sociability",
  ),
  scale(
    "stacy-independence",
    "How strongly do you protect your independence?",
    "independence",
    "I thrive through togetherness",
    "It is non-negotiable",
    "confidence",
  ),
  scale(
    "stacy-ambition",
    "How ambitious are you about the life you want?",
    "ambition",
    "Peace matters more than achievement",
    "I plan to reach the very top",
    "discipline",
  ),
  scale(
    "stacy-sociability",
    "How energized are you by a full social calendar?",
    "sociability",
    "It drains me",
    "I come alive",
    "humor",
  ...
  scale(
    "stacy-creativity",
    "How much does self-expression shape your choices?",
    "creativity",
    "Rarely",
  ...
  scale(
    "stacy-calmness",
    "How composed are you when plans collapse?",
    "calmness",
    "My emotions arrive first",
    "Almost impossible to rattle",
    "discipline",
  ),
  scale(
    "stacy-adventure",
    "How willing are you to reinvent your life?",
    "adventurousness",
    "I protect what is familiar",
    "I would start over tomorrow",
    "independence",
  ),
  scale(
    "stacy-sophistication",
    "How much do refinement and taste matter to you?",
    "sophistication",
    "Not at all",
    "They shape my whole world",
    "creativity",
  ),
  scale(
    "stacy-humor",
    "How often is humor your social superpower?",
    "humor",
    "I tend to stay serious",
    "Constantly",
    "sociability",
  ),
  scale(
    "stacy-discipline",
    "How structured is your pursuit of a goal?",
    "discipline",
  ...
  scale(
    "stacy-mystery",
    "How much of yourself do you keep private?",
    "independence",
    "Very little",
  ...
  scale(
    "stacy-competition",
    "How competitive are you when excellence is on the line?",
    "ambition",
    "I do not compare",
    "I intend to win",
    "confidence",
  ...
  scale(
    "stacy-routine",
    "How important is a personal routine?",
    "discipline",
  ...
  scale(
    "stacy-risk",
    "How much risk belongs in a life well lived?",
    "adventurousness",
    "Very little",
    "The best parts require it",
    "confidence",
  ),
  scale(
    "stacy-presence",
    "How naturally magnetic is your presence?",
    "confidence",
    "I am quietly in the background",
    "People notice before I speak",
    "sociability",
  ),
...
export const CHAD_QUESTIONS: Question[] = [
  ...
  scale(
    "chad-confidence",
    "How easily do you back yourself in uncertain situations?",
    "confidence",
    "I need reassurance",
    "Without hesitation",
    "calmness",
  ...
  scale(
    "chad-discipline",
    "How disciplined is your daily routine?",
    "discipline",
    "I resist routines",
  ...
  scale(
    "chad-ambition",
    "How far are you willing to push for mastery?",
    "ambition",
    "Balance comes first",
    "As far as it takes",
    "discipline",
  ...
  scale(
    "chad-independence",
    "How comfortable are you operating alone?",
    "independence",
  ...
  scale(
    "chad-sociability",
    "How much energy do you draw from a crowd?",
    "sociability",
    "Crowds drain me",
    "I command them naturally",
    "confidence",
  ),
  scale(
    "chad-adventure",
    "How often do you seek physical or real-world adventure?",
    "adventurousness",
    "Almost never",
    "Whenever possible",
    "confidence",
  ...
  scale(
    "chad-calmness",
    "How steady are you when provoked?",
    "calmness",
    "I react instantly",
    "I stay completely measured",
    "discipline",
  ),
  scale(
    "chad-humor",
    "How central is humor to your charm?",
    "humor",
    "I am mostly serious",
    "It is my strongest move",
    "sociability",
  ),
  scale(
    "chad-taste",
    "How much attention do you give to quality and taste?",
    "sophistication",
    "Function is enough",
  ...
  scale(
    "chad-originality",
    "How strongly do you resist doing what is expected?",
    "creativity",
    "I value proven paths",
    "I make my own rules",
    "independence",
  ),
  ...
  scale(
    "chad-risk",
    "How much calculated risk are you willing to carry?",
    "adventurousness",
    "Very little",
    "A great deal",
    "ambition",
  ...
  scale(
    "chad-leadership",
    "How naturally do you take the lead?",
    "confidence",
    "I prefer supporting",
  ...
  scale(
    "chad-focus",
    "How long can you stay locked onto one difficult goal?",
    "discipline",
    "I need variety",
    "Until it is done",
    "ambition",
